  ...
  return (
    <div className="max-w-4xl mx-auto">
      <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-6 md:p-8">
        <h2 className="text-2xl sm:text-3xl font-bold text-gray-900 dark:text-white mb-2">Manage Question Bank</h2>
        <p className="text-gray-600 dark:text-gray-300 mb-6">The app is pre-loaded with sample questions. You can replace them by uploading your own Excel file below.</p>
